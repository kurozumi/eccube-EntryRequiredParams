...
class plugin_info
{
    ...
    static $PLUGIN_CODE = "EntryRequiredParams";

    /** プラグイン名(必須)：プラグイン管理・画面出力（エラーメッセージetc）にはこの値が出力されます。 */
    static $PLUGIN_NAME = "会員登録ページの必須項目を設定できるプラグイン";

    /** プラグインメインクラス名(必須)：本体がプラグインを実行する際に呼ばれるクラス。拡張子は不要です。 */
    static $CLASS_NAME = "EntryRequiredParams";
    ...
    /** 説明(必須) */
    static $DESCRIPTION = "会員登録ページの必須項目を設定できるプラグインです。";
