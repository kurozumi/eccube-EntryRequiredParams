 ...
 * @version $Id: $
 */
class EntryRequiredParams extends SC_Plugin_Base
{
    /**
     * コンストラクタ
     *
    ...
    public function register(SC_Helper_Plugin $objHelperPlugin, $priority)
    {
        ...
        $objHelperPlugin->addAction("LC_Page_Entry_action_after", array(&$this, "products_list_action_after"), $priority);
    ...
    public function loadClassFileChange(&$classname, &$classpath)
    {
        ...
        if ($classname == "SC_Helper_Customer_Ex") {
            $classname = "plg_EntryRequiredParams_SC_Helper_Customer";
            $classpath = $helper_path . $classname . ".php";
        }        
    }
    
    public function LC_Page_Entry_action_after(LC_Page_EX $objPage)
    {
